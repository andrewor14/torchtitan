...
# Following verl reference: GSM8K + MATH combined
set -xeuo pipefail
...
# Reference uses 512 batch, but we use 256 to fit memory
...
experiment_name=${EXPERIMENT_NAME:-qwen3_30b_a3b_torchtitan}
