...
def _dispatch_backward(
    ...
    # num_max_tokens_per_rank, expert_alignment, cudagraphable. Backward only runs on the
    # compact (cudagraphable=False) path; the expand layout is inference-only
    # ("must not be backward"). expert_alignment is 1 there (compact pads in Python).
